    ...
    return (
        ...
        >
            <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
                        ...
                        {navigation.map((item) => (
                            <a
                                ...
                                className={`block relative font-code text-2xl uppercase text-n-1 transition-colors hover:text-color-1 ${item.onlyMobile ? "lg:hidden" : ""
                                    } px-6 py-6 md:py-8 lg:-mr-0.25 lg:text-[1rem] lg:font-semibold ${item.url === pathName.hash
                                        ? "z-2 lg:text-n-1"
                                        : "lg:text-n-1/50"
                ...
                <a
                    href="#signup"
                    className="button lg:text-[1rem] hidden mr-8 text-n-1/50 transition-colors hover:text-n-1 lg:block"
                >
                    New account
                </a>
